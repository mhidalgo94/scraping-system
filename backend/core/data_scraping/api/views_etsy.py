...
class EtsyListAPI(ListAPIView):
    serializer_class  = EtsySerializerAPI
...
class EtsyUpdateAPI(UpdateAPIView):
    serializer_class = EtsySerializerAPI
    permission_classes = [IsAuthenticated]
    lookup_field = 'id'
...
class EtsyListSearchAPI(ListAPIView):
    serializer_class  = EtsySerializerAPI
    permission_classes = [IsAuthenticated]
...
class EtsyListSearchFavoriteAPI(ListAPIView):
    serializer_class  = EtsySerializerAPI
    permission_classes = [IsAuthenticated]
