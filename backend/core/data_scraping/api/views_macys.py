...
class MacysListAPI(ListAPIView):
    serializer_class  = MacysSerializerAPI
...
class MacysUpdateAPI(UpdateAPIView):
    serializer_class = MacysSerializerAPI
    permission_classes = [IsAuthenticated]
    lookup_field = 'id'
...
class MacysListSearchAPI(ListAPIView):
    serializer_class  = MacysSerializerAPI
    permission_classes = [IsAuthenticated]
...
class MacysListSearchFavoriteAPI(ListAPIView):
    serializer_class  = MacysSerializerAPI
    permission_classes = [IsAuthenticated]
